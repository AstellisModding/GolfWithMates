...
import net.astellismodding.golfwithmates.common.CommonEventHandler;
import net.astellismodding.golfwithmates.entity.ModEntities;
import net.astellismodding.golfwithmates.init.ModCreativeModeTabs;
...
import net.astellismodding.golfwithmates.loot.ModLootModifiers;
...
@Mod(GolfWithMates.MOD_ID)
public class GolfWithMates {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "golfwithmates";
    ...
    public GolfWithMates(IEventBus modEventBus, ModContainer modContainer) {
        ...
        commonEventHandler.registerHandler(modEventBus);
